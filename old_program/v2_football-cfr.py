...
payoff, information_set, infoset_player, infoset_action, infoset_chance, sigma, nu_sigma_list, sigma_sum, Regret, pi_i_sum = v2_cfr_axu.create_master_data(action, chance_action)
        ...
        if i == 0:
            if payoff[h[0]][h[1]][h[2]] >= 10:
                ...
                if str(h) in child_EU_dict:
                    ...
                    EU = v2_cfr_axu.CFR_child( Decimal(str(payoff[h[0]][h[1]][h[2]])), h, itelater, player, action, chance_action )
